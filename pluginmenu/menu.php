 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_n')){
	function azrcrv_create_plugin_menu_n(){
		azrcrv_populate_plugin_menu_n();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_n')){
	function azrcrv_populate_plugin_menu_n(){
